Rails.application.configure do
  ...
  # Do not turn emtpy arrays in params into nil objects- so we can send issuances to controller from Angular for calculations
  ...
  config.cache_store = :redis_store, ENV["REDISTOGO_URL"], { expires_in: 12.hours }
end
